...
Pocketblue uses a Fedora ark-based kernel (via arkify) with additional patches for Qualcomm SC7280 (QCM6490/Kodiak) support. It is currently built in the [lorbus/misc COPR repository](https://copr.fedorainfracloud.org/coprs/lorbus/misc/) from [LorbusChris/linux-sc7280](https://github.com/LorbusChris/linux-sc7280), and should move to [pocketblue/sc7280](https://copr.fedorainfracloud.org/coprs/pocketblue/sc7280/) alongside the other SC7280 packages.

Everything else comes from the [pocketblue/common COPR repository](https://copr.fedorainfracloud.org/coprs/pocketblue/common/), whose repo file is installed for all devices by `common/build`.
